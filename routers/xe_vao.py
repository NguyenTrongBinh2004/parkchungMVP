...
# ❌ ĐÃ XÓA: from services.ocr import nhan_dien_bien_so
...
# ───────────────────────────────────────────
# 1. NHẬN DIỆN (QR → fallback nhập tay)
# ───────────────────────────────────────────
...
async def nhan_dien_xe_vao(
    ...
    # ── Thử QR trước (qr_service đã có tiền xử lý ảnh tốt hơn) ──
    try:
        ...
        pass  # QR không đọc được → nhập tay
