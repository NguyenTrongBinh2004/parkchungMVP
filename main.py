...
from routers import loai_xe, xe_ra, thanh_toan, xe_vao, ve_thang, bao_cao, tim_xe, danh_sach_xe, auth, bai_xe, dat_cho_web
...
app.include_router(bai_xe.router)
app.include_router(dat_cho_web.router)
